  ...
  return (
    <div className="shopWindow">
      <div className="shop-header">
        <div className="shop-header-title">{shop?.shopName}</div>
        <div onClick={game.toggleShop} className="shop-close">
          X
        </div>
      </div>
      ...
      <div className="shop-content">
        <div className="shop-section">
          <div className="shop-title">My Inventory</div>
        ...
        <div className="shop-section">
          <div className="shop-title">Shop Inventory</div>
          <table className="shop-table">
            <tbody>
